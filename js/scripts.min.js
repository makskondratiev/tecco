...
$(".company__quoteblock_slider").each(function(){
    var slider = $(this),
        slidesamount = slider.find(".company__quoteimage img").length, // кол-во слайдов
        currentslide = 1;
    ...
    function changeslide() {
        setTimeout(function(){
            slider.find(">div").addClass("active");
        }, 1);
        setTimeout(function(){
            slider.find(".company__quoteimage img:nth-of-type("+currentslide+")").addClass("active").siblings().removeClass("active");
            slider.find(".company__quotecontent:nth-of-type("+currentslide+")").addClass("active").siblings().removeClass("active");
        }, 1000);
        setTimeout(function(){
            slider.find(">div").removeClass("active");
        }, 1001);
    }
});
