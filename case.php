...
<section class="content case">
	<div class="content-tabs">
		<div class="container">
			<p class="case__name">Venden group</p>
	...
	<div class="case__slider">
		...
		<div class="case__slidearrows">
			<div class="prev">
				<svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.62 34.25" width="19" height="35"><title>icon_arrow_5</title><polyline points="1.5 1.5 17.12 17.12 1.5 32.75" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/></svg>
			</div>
			<div class="next">
				<svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.62 34.25" width="19" height="35"><title>icon_arrow_5</title><polyline points="1.5 1.5 17.12 17.12 1.5 32.75" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/></svg>
			</div>
	...
	<div class="case__bigimage">
		...
		<img class="case__logo case__logo_bottom" src="img/logo_venden_white.svg" alt="@@">
	</div>
	...
	<div class="case__contactblock">
		<div class="container">
			<a href="#" class="squareblock squareblock_dark">
				<p class="content__text"><b>You like the project?</b><br><br>
				Wana make something as good as this?</p>
				<p class="content__text content__text_link" href="#">Contact us!
				...
				<span class="squareblock__social">Share
